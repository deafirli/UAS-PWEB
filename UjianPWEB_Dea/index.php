  ...
  <div id="app">
    ...
    <aside class="aside is-placed-left is-expanded">
      ...
      <div class="menu is-menu-main">
        ...
        <ul class="menu-list">
          <li>
            <a href="index.php?page=home" class="is-active router-link-active has-icon">
        ...
        <ul class="menu-list">
          <li>
            <a href="index.php?page=input" class="is-active router-link-active has-icon">
              <span class="icon has-update-mark"><i class="mdi mdi-table"></i></span>
              <span class="menu-item-label">Input Mahasiswa</span>
            </a>
          </li>
        </ul>
      </div>
    ...
    if (isset($_GET['page'])) {
      switch ($_GET['page']) {
        case 'home':
          include("pages/tabel_mahasiswa.php");
          break;
        case 'input':
          include("pages/input_mahasiswa.php");
          break;
        case 'edit':
          include('pages/edit_mahasiswa.php');
          break;
        default:
          include("pages/tabel_mahasiswa.php");
          break;
